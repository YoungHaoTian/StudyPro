        ...
        <div class="panel panel-default wk-panel wk-table-tools-panel">
            ...
            <div style="position: absolute;top: -11px;left: 240px;">
                <form class="navbar-form navbar-right" role="search"
                    ...
                    <div class="form-group">
                        <label for="" class="control-label wk-filed-label">所属学院:</label>
                ...
                <div>
                    <button id="deleteBtn" type="button" class="btn btn-default wk-tool-btn"
                            style="position: absolute;top: 10px;right: -320px;">删除
                    </button>
                    <button id="updateBtn" type="button" class="btn btn-default wk-tool-btn"
                            style="position: absolute;top: 10px;right: -400px;">编辑
                    </button>
                </div>
            </div>
            <!-- 搜索 end -->
...
<script>
    ...
    $("#updateBtn").on("click", function () {
        ...
        if (id != "") {
            location.href = "updateStudent/" + id + ".html";
        }
    });
