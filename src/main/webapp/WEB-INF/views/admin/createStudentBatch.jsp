...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default wk-panel ">
            ...
            <form action="${APP_PATH}/admin/createStudentBatch" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-inline">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <a class="btn btn-link" href="${APP_PATH}/admin/downloadTemplate">点击下载模板</a>
                                </div>
                            </div>
                        </div>
                    </div>
