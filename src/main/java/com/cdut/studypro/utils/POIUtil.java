...
public class POIUtil {
    ...
    public static boolean checkHSSFCellType(HSSFCell hssfCell) {
        return hssfCell.getCellType() == CellType.STRING;
    }

    public static boolean checkXSSFCellType(XSSFCell xssfCell) {
        return xssfCell.getCellType() == CellType.STRING;
    }
