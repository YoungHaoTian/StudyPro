                    ...
                    <div class="row">
                        ...
                        <div class="form-inline">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <a class="btn btn-link" href="${APP_PATH}/admin/downloadCollegeTemplate">点击下载模板</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function upload() {
        ...
        $.ajax({
            url: "${APP_PATH}/admin/collegeDataImport",
            type: 'POST',
            dataType: 'json',
            ...
            success: function (result) {
                ...
                if (result.code === 100) {
                    layer.msg("学院批量导入成功", {time: 1000, icon: 1}, function () {
                    });
                }
            },
            error: function () {
