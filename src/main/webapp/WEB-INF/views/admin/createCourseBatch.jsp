                    ...
                    <div class="row">
                        <div class="form-inline">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <a class="btn btn-link" href="${APP_PATH}/admin/downloadCourseTemplate">点击下载模板</a>
                                </div>
                            </div>
                        </div>
                        <div class="form-inline">
                            <div class="form-group" style="margin-left: 30px">
                                <span style="color: red">注：为了及时更新表格中教师和学院信息，请每次导入之前下载模板</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function upload() {
        ...
        $.ajax({
            url: "${APP_PATH}/admin/courseDataImport",
            type: 'POST',
            dataType: 'json',
            ...
            success: function (result) {
                ...
                if (result.code === 100) {
                    layer.msg("课程批量导入成功", {time: 1000, icon: 1}, function () {
                    });
                }
            },
            error: function () {
