            ...
            <div class="step-content">
                        ...
                        <div class="form-group clearfix">
                            <div style="text-align: center">
                                <label class="radio-inline">
                                    <input type="radio" value="student" name="role" checked="checked"><span>学生找回</span>
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" value="teacher" name="role"><span>教师找回</span>
                                </label>
                            </div>
                        </div>
                    </form>
                ...
                <div class="step-list">
                    <div class="ok_style center">
                        ...
                        <h5 class="color2 mtb20">你已成功找回密码<b id="sec">5</b>秒后跳转到登录页面</h5>
                        <a href="javaScript:void(0);" class="btn btn-danger back" id="back"
                           style="margin-right: 20px">返回登录</a>
                        <a href="javaScript:void(0);" class="btn btn-primary" id="goBtn">重新找回</a>
                    </div>
                </div>
            </div>
        </div>
